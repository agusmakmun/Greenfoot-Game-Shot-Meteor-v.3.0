...
/**
 * Ini adalah bumMeteor(); dimana agar ketika terjadi tabrakan antara Rocket dengan -->
 * Meteor, akan terjadi ledakan dikeduanya.
 * Script ini kami dapatkan dari forum Greenfoot.org
 * bumMeteor() ini juga merupakan turunan dari setMeledak();
 * 
 * @author (Summon Agus - Agus Makmun - L200130113) 
 * @blog (bloggersmart.net)
 * @version (Update: v.3.0)
 */
public class bumMeteor extends setMeledak
{
    /**
    ...
    public synchronized static void initialiseImages(int maxs) {
        if(images == null) {
            GreenfootImage baseImage = new GreenfootImage("Meledak.png");
